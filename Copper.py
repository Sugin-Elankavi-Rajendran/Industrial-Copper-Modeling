...
st.markdown(
    ...
    body {
        background-image: url('https://stormgain.com/sites/default/files/2021-01/dash_pp-main.jpg');
...
st.write("""
<div class='title'>
    <h1>Industrial Copper Modeling Application</h1>
</div>
""", unsafe_allow_html=True)
...
with tab1:
    ...
    with st.form("predict_price_form"):
        ...
        with col3:
            st.write(f'<h5 style="color:rgb(0, 0, 255,0.6);">NOTE: Min & Max values are provided for reference.</h5>', unsafe_allow_html=True)
